...
public class Shoubatsu {
	...
	// 김현서 金現徐
    // 특정 사원의 상벌 정보를 조회하는 메소드
	// 人事記録カード_特定社員の賞罰情報を照会するメソッド
    public Shoubatsu(String shouBatsuKubun, String shouBatsuMei, String shouBatsuSha, Date shouBatsu_bi, String shouBatsuNaiyou, String bikou) {
        this.shouBatsuKubun = shouBatsuKubun;
        this.shouBatsuMei = shouBatsuMei;
        this.shouBatsuSha = shouBatsuSha;
        this.shouBatsu_bi = shouBatsu_bi;
