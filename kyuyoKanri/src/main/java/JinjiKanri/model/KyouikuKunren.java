...
public class KyouikuKunren {
	...
	public KyouikuKunren(Integer kunren_id, Integer shain_id, String kunren_shubetsu, String kyouiku_mei, Date kaishi_bi,
	...
	// 김현서 金現徐
    // 특정 사원의 교육훈련 정보를 조회하는 메소드
	// 人事記録カード_特定社員の教育訓練情報を照会するメソッド
    public KyouikuKunren(String kunren_shubetsu, String kyouiku_mei, Date kaishi_bi, Date shuuryou_bi, String kikan, BigDecimal kyouiku_hiyou, BigDecimal henkin_hiyou) {
        this.kunren_shubetsu = kunren_shubetsu;
        this.kyouiku_mei = kyouiku_mei;
        this.kaishi_bi = kaishi_bi;
        this.shuuryou_bi = shuuryou_bi;
