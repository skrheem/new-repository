...
public class Shain {
	...
	public Shain(Integer shain_id, String namae_kana, Date nyuusha_nengappi, Date taisha_nengappi, String jyoutai,
		...
		// taishokuseisankubun이 null인지 확인 후 처리 (수정된 부분)
	...
	public String toString() {
	    return "Shain {" +
	            "shain_id=" + shain_id +
	            ", namae_kana='" + namae_kana + '\'' +
	            ", nyuusha_nengappi=" + nyuusha_nengappi +
	            ", taisha_nengappi=" + taisha_nengappi +
	            ", jyoutai='" + jyoutai + '\'' +
	            ", busho_mei='" + busho_mei + '\'' +
	            ", yakushoku_mei='" + yakushoku_mei + '\'' +
	            ", kinzokunensu=" + kinzokunensu +
	            ", chuukanseisan='" + chuukanseisan + '\'' +
	            ", taishokuseisan='" + taishokuseisan + '\'' +
	            '}';
	}
}
